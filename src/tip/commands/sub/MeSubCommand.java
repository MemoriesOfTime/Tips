 ...
 * @author SmallasWater
 */
public class MeSubCommand extends BaseSubCommand {
    public MeSubCommand(String name) {
        super(name);
    }
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        if (sender instanceof Player) {
            ListenerWindow.CHOSE_TYPE.put(sender.getName(),2);
    ...
    public boolean hasPermission(CommandSender sender) {
        return sender.hasPermission("tips.me");
    }
