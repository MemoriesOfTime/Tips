...
public class AchAllSubCommand extends BaseSubCommand {
    ...
    public boolean execute(CommandSender sender, String label, String[] args) {
        if(sender instanceof Player) {
            FormWindowSimple simple = new FormWindowSimple("§e§lAchievements System", "");
            StringBuilder builder = new StringBuilder();
            builder.append("§7Achievements load: §2").append(((Player) sender).achievements.size()).append("§r/§7").append(Achievement.achievements.size()).append("§r\n");
